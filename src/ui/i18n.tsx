...
const messages: Record<Locale, Messages> = {
  ru: {
    ...
    difficultyMedium: "Средняя (2 полухода)",
    difficultyHard: "Сложная (до 3 полуходов)",
  ...
  en: {
    ...
    difficultyMedium: "Medium (2 plies)",
    difficultyHard: "Hard (up to 3 plies)",
  ...
  "zh-CN": {
    ...
    difficultyMedium: "中等（2 个半回合）",
    difficultyHard: "困难（最多 3 个半回合）",
    startLocal: "开始本地对局",
